...
struct PronunciationFeedback {
    let score: Int; let accuracy: String; let feedback: String; let improvements: [String]; let tips: String
}

struct PrayerPhrase: Identifiable {
    let id = UUID(); let text: String; let translation: String?; let difficulty: PracticeDifficulty
}
